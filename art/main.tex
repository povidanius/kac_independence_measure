...
Epoch 7/7, Training Loss: 0.075, Training Accuracy: 96.458, Validation Loss: 0.124, Validation Acc: 100.000

Test accuracy is 77.885
Regularization: True

Epoch 7/7, Training Loss: 0.042, Training Accuracy: 96.875, Validation Loss: 0.012, Validation Acc: 100.000
Test accuracy is 81.891


\subsection{Regularisation}
In regularisation experiments we investigate chest x-ray classification task. It is represented as binary classification data set, consisting of x-ray scans, which should be classified as pneumonia or normal (e.g. Figure~\ref{fig:Pneumonia_dataset_examples}). As classifier we use \emph{ResNet18}, trained with batches of $128$ elements.
...
We sincerely thank Dr. Pranas Vaitkus, and colleagues from Neurotechnology for discussions.
